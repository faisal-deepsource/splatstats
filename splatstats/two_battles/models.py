...
WeaponSpecials = (
    (("1001"), _("Autobomb Launcher")),
    (("31", "50", "300", "200", "242", "1011", "1101", "2001", "2012", "2022", "3001", "3041", "4040"), _("Baller")),
    (("32", "52", "72", "1022", "4012"), _("Booyah Bomb"))
    (("12", "71", "312", "401", "221", "1012", "2031", "2041", "2052", "3040", "4011"), _("Bubble Blower")),
    (("2051", "3002"), _("Burst-Bomb Launcher")),
    (("30"), _("Curling-Bomb Launcher")),
    (("10", "60", "80", "311", "251", "1021", "1102", "2000", "3010", "4021"), _("Ink Armor")),
    (("11", "62", "70", "202", "220", "250", "1000", "2030", "2040", "3011", "3030", "4001", "4031"), _("Ink Storm")),
    (("20", "41", "46", "301", "211", "241", "1110", "1115", "2002", "2061", "4030", "4041"), _("Inkjet")),
    (("0", "40", "45", "81", "210", "215", "1010", "1015", "1100", "2060", "3022", "4020"), _("Splashdown")),
    (("240", "1030", "3021"), _("Splat-Bomb Launcher")),
    (("51", "91", "400", "230", "1020", "2010", "2015", "2020", "3020", "4010", "4015"), _("Sting Ray")),
    (("21", "201", "2011", "2021", "3031"), _("Suction-Bomb Launcher"))
    (("1", "42", "61", "90", "310", "222", "231", "1031", "1111", "2050", "3000", "3005", "4000"), _("Tenta Missiles")),
    (("2", "302", "1112", "4002"), _("Ultra Stamp")),
)
...
class Battle(models.Model):
    ...
    def create(cls, **kwargs):
        ...
        if "stat_ink_json" in kwargs:
            ...
            rule = rules.get(stat_ink_json["rule"]["key"])
            ...
            if stat_ink_json["species"] is not None:
                player_species = species.get(stat_ink_json["species"]["key"])
            else:
                player_species = None
            main_abilities = {
                "ink_saver_main": "0",
                    ...
                    if players.index(player) not in processed_players:
                        if player["team"] == "my":
                            ...
                            if player["rank"] is not None:
                                ...
                                ] = rank_to_id.get(player["rank"]["key"])
                            else:
                            ...
                            if player["species"] is not None:
                                ...
                                ] = species.get(player["species"]["key"])
                            else:
